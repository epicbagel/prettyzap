...
opens settings, and right-click opens the control panel. The control panel
includes a `Hide badge` / `Show badge` action; it hides only the unread count
and does not change WhatsApp notification permissions.
